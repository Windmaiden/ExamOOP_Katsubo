...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->T_1->Tick += gcnew System::EventHandler(this, &MyForm1::T_1_Tick);
			// 
			// T_2
			// 
			this->T_2->Interval = 1200;
			this->T_2->Tick += gcnew System::EventHandler(this, &MyForm1::T_2_Tick);
			// 
			// Timer
			// 
			...
			this->Timer->Click += gcnew System::EventHandler(this, &MyForm1::Timer_Click);
			// 
			// button2
			// 
			...
			this->B_1->Tick += gcnew System::EventHandler(this, &MyForm1::B_1_Tick);
			// 
			// B_2
			// 
			this->B_2->Interval = 1200;
			this->B_2->Tick += gcnew System::EventHandler(this, &MyForm1::B_2_Tick);
			// 
			// B_3
			// 
			this->B_3->Interval = 1200;
			this->B_3->Tick += gcnew System::EventHandler(this, &MyForm1::B_3_Tick);
			// 
			// P_B
			// 
			...
			this->P_T->Tick += gcnew System::EventHandler(this, &MyForm1::P_T_Tick);
			// 
			// button3
			// 
			...
			this->V_1->Tick += gcnew System::EventHandler(this, &MyForm1::V_1_Tick);
			// 
			// V_2
			// 
			this->V_2->Interval = 1400;
			this->V_2->Tick += gcnew System::EventHandler(this, &MyForm1::V_2_Tick);
			// 
			// V_3
			// 
			this->V_3->Interval = 1200;
			this->V_3->Tick += gcnew System::EventHandler(this, &MyForm1::V_3_Tick);
			// 
			// V_4
			// 
			this->V_4->Interval = 1200;
			this->V_4->Tick += gcnew System::EventHandler(this, &MyForm1::V_4_Tick);
			// 
			// MyForm
			// 
